...
Class  Order extends Controller
{
      ...
      public function save_order($POST,$ROWS,$user_url,$sessionid)
        { 
           ...
           $query = " insert into orders (user_url,delivery_address,total,country,state,zip,tax,shipping,date,sessionid,mobile_phone,home_phone) values (:user_url,:delivery_address,:total,:country,:state,:zip,:tax,:shipping,:date,:sessionid,:mobile_phone,:home_phone)";
