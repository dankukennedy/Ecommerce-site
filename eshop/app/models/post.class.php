      ...
      public function create($DATA,$FILES,$image_class = null)
       {
         $_SESSION['error'] = "";
          ...
          $DB =  Database::newInstance();
           ...
           {
               $_SESSION['error'] .= " please enter a valurl_address title for this post<br>";
           }

           if(empty($arr['post']))
           {
               $_SESSION['error'] .= " please enter some valurl_address content<br>";
           }

           //make sure url_address unique
