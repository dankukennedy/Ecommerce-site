...
?>
    ...
    <?php if(is_array($orders)):?>
            <div class="register-req">
                <p>Please fill out the the information below </p>
            </div><!--/register-req-->
                      ...
                      <table style="width:100%; background-color: #eee;"><tr><td style="text-align:center; padding: 1em;"><?=$order->message?></td></tr></table>
                          ...
                          <table class="table">
                                ...
                                <thead>
                                   ...
                                   <?php if(isset($order_details) && is_array($order_details)): ?>                               <?php foreach($order_details as $detail): ?>
        ...
        <?php else: ?>
        <h3 style="text-align: center; ">Please add some items in the cart first!</h3>
      <?php endif;?>
                  <hr style="clear:both;">
