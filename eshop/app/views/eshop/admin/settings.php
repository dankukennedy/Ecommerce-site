    ...
    <form method="post" enctype="multipart/form-data">
      <table class="table table-striped table-advance table-hover">
      	...
      	<?php  if($type == "socials"):?>
			    ...
			    <tbody>
			 	...
			 	<tr>
		          ...
		          <input type="submit" value="Save Setting" class="btn btn-warning pull-right">	
          ...
          <div class="form-group">
              ...
              <input id="link" type="text" value="<?=(isset($POST['link'])) ? $POST['link']: ''; ?>" class="form-control" name="link" placeholder="e.g http://yourwebsite.com/ypur_product">
          </div>
