                            ...
                            <!-- add new product -->
                              ...
                              <form class="form-horizontal style-form" method="post">
                                  <div class="form-group">
                                   ...
                                   <br><br style="clear:both">
                                   <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Image2 (optoinal): </label>
                                      <div class="col-sm-10">
                                   ...
                                   <br><br style="clear:both">
                                   <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Image3 (optoinal): </label>
                                      <div class="col-sm-10">
                                   ...
                                   <br><br style="clear:both">
                                   <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Image4 (optoinal): </label>
                                      <div class="col-sm-10">
