<?php $this->view("admin/header",$data) ;?>
 ...
 <style type="text/css">
      ...
      <table class="table table-striped table-advance table-hover">
       	...
       	<?php if($mode == "read"):?>
               <thead>
           			<tr><th>Name</th><th>subject</th><th>Email</th><th>Message</th><th>Date created</th><th>Action</th></th></tr>        			
		 	...
		 	<?php if(isset($messages) && is_array($messages)):?>  
			 	...
			 	<tr style="position:relative;"><td><?=$message->name?></td><td><?=$message->subject?></td><td><?=$message->email?></td><td><?=$message->message?></td></td><td><?=date("jS M Y H:i a", strtotime($message->date))?></td>
	      ...
	      <?php elseif($mode == "delete" && is_object($messages)):?> 
              ...
              <tbody>
	 	<tr style="position:relative;"><td><?=$messages->name?></td><td><?=$messages->subject?></td><td><?=$messages->email?></td><td><?=$messages->message?></td></td><td><?=date("jS M Y H:i a", strtotime($messages->date))?></td>
